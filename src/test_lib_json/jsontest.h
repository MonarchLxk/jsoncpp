...
public:
    ...
    TestResult &addFailure(const char *file, unsigned int line, const char *expr = nullptr);
...
#define JSONTEST_ASSERT_STRING_EQUAL(expected, actual)                                                               \
    JsonTest::checkStringEqual(*result_, JsonTest::ToJsonString(expected), JsonTest::ToJsonString(actual), __FILE__, \
...
#define JSONTEST_FIXTURE_V2(FixtureType, name, collections)                            \
    ...
    public: /* overridden from TestCase */                                             \
        ...
        void runTestCase() override;                                                   \
                                                                                       ...
                                                                                       \
    static bool test##FixtureType##name##collect = Test##FixtureType##name::collect(); \
                                                                                       \
    void Test##FixtureType##name::runTestCase()
